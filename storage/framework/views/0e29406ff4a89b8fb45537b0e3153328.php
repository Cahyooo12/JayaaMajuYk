    ...
    <div class="max-w-md w-full bg-white p-8 rounded-2xl shadow-xl border border-slate-100">
        ...
        <form method="POST" action="<?php echo e(route('admin.authenticate')); ?>" class="space-y-6">
            ...
            <div>
                ...
                <input type="text" name="username" class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:outline-none focus:border-primary font-bold text-slate-800" placeholder="admin" required>
            </div>
            <div>
                <label class="block text-sm font-bold text-slate-700 mb-2">Password</label>
                <input type="password" name="password" class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:outline-none focus:border-primary font-bold text-slate-800" placeholder="••••••••" required>
            </div>
        ...
        <div class="text-center mt-6">
            <a href="<?php echo e(route('home')); ?>" class="text-sm text-slate-400 hover:text-primary">Kembali ke Website</a>
        </div>
    </div>
</body>
</html>
<?php /**PATH C:\JAYA Maju\resources\views/admin/login.blade.php ENDPATH**/ ?>