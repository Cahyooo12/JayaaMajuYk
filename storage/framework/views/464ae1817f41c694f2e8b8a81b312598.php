...
<head>
    ...
    <!-- SEO Meta Tags -->
    <title><?php echo $__env->yieldContent('title', 'Jaya Maju Yk'); ?></title>
    <meta name="description" content="<?php echo $__env->yieldContent('description', 'Distributor resmi mesin kasir, printer thermal, barcode scanner, dan peralatan kasir lengkap di Jogja.'); ?>">
    <meta name="keywords" content="<?php echo $__env->yieldContent('keywords', 'mesin kasir jogja, jual mesin kasir yogyakarta, printer kasir murah jogja'); ?>">
    ...
    <div class="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
        ...
        <div class="flex items-center gap-6">
            <div class="hidden md:flex items-center gap-8">
                <a href="<?php echo e(route('catalog')); ?>" class="text-sm font-bold text-slate-600 hover:text-primary transition-colors">Katalog</a>
                <a href="<?php echo e(route('admin.login')); ?>" class="text-sm font-bold text-slate-600 hover:text-primary transition-colors">
                    <?php echo e(session('user') ? 'Admin Panel' : 'Login Admin'); ?>
            ...
            <div class="flex items-center gap-3 pl-6 border-l border-slate-200">
                <a href="<?php echo e(route('compare')); ?>" class="relative p-2 text-slate-600 hover:text-primary transition-colors" title="Bandingkan">
                    ...
                    <?php if(session('compare') && count(session('compare')) > 0): ?>
                        <span class="absolute top-0 right-0 size-5 bg-secondary text-white text-[10px] font-black rounded-full flex items-center justify-center shadow-sm border-2 border-white">
                            <?php echo e(count(session('compare'))); ?>

                        </span>
                    <?php endif; ?>
                </a>
                
                <a href="<?php echo e(route('cart')); ?>" class="relative p-2 text-slate-600 hover:text-primary transition-colors" title="Keranjang">
...
<footer class="bg-slate-900 text-white pt-24 pb-12 border-t border-slate-800">
    <div class="max-w-7xl mx-auto px-6">
        ...
        <div class="pt-8 border-t border-slate-800 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-slate-500">
            <p>&copy; <?php echo e(date('Y')); ?> Jaya Maju Yk. All rights reserved.</p>
...
<?php /**PATH C:\JAYA Maju\resources\views/layouts/app.blade.php ENDPATH**/ ?>