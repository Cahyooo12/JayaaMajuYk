...
// Get a few featured products (e.g., first 3 items or specific IDs)
$all_products = get_products();
$featured_products = array_slice($all_products, 0, 3);

// Page SEO
$page_title = 'Jaya Maju Yk';
$page_desc = 'Distributor resmi mesin kasir, printer thermal, barcode scanner, dan sistem POS lengkap di Yogyakarta. Solusi tepat untuk UMKM hingga Enterprise.';
?>
...
<section class="relative overflow-hidden pt-10 pb-20 md:pt-16 md:pb-32">
    ...
    <div class="bg-[#0E3481] rounded-[3.5rem] p-8 md:p-20 text-white shadow-[0_40px_100px_-20px_rgba(14,52,129,0.3)] relative overflow-hidden">
        ...
        <div class="flex flex-col gap-8">
            ...
            <a href="catalog.php" class="group bg-secondary text-white px-10 py-5 rounded-2xl font-black hover:bg-opacity-90 transition-all flex items-center gap-3 shadow-xl hover:-translate-y-1 active:scale-95">
                Buka Katalog 
...
<section class="max-w-[1200px] mx-auto px-6 pb-20">
    <div class="flex flex-col md:flex-row md:items-end justify-between gap-10 mb-12">
        ...
        <a href="catalog.php" class="flex items-center gap-2 text-primary font-bold hover:gap-4 transition-all">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <div class="group bg-white rounded-3xl border border-slate-100 p-4 transition-all duration-300 hover:border-primary/20 hover:shadow-2xl hover:shadow-primary/5 hover:-translate-y-1 flex flex-col h-full active:border-primary/50">
            ...
            <div class="mt-6 pt-4 border-t border-slate-50 flex gap-3 relative z-20">
                <a href="product.php?id=<?php echo $product['id']; ?>" class="flex-1 bg-slate-100 hover:bg-primary hover:text-white text-slate-600 font-bold py-4 rounded-xl transition-all flex items-center justify-center gap-2 text-sm active:scale-95">
                    Lihat Detail
                </a>
            </div>
        </div>
